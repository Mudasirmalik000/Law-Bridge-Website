...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      <div class="pl-4 flex items-center">
        <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
          ...
          <img src="logo_1.webp" alt="" class="rounded-full w-[4rem]">

        </a>

      </div>
      <div class="pl-4 flex items-center max-[325px]:hidden">
        <h1 class="font-bold text-2xl toggleColour" style="letter-spacing: 4px;">LAW BRIDGE</h1>
      </div>
      <div class="block lg:hidden pr-4">
        <button id="nav-toggle toggleColor"
      ...
      <div
        ...
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
          <li class="mr-3">
            <a class="inline-block hover:underline ease-in-out duration-300 py-2 px-4 text-white toggleColour text-xl font-bold no-underline"
  ...
  <!-- carousel -->
  <section class="my-auto px-0 max-[668px]:mt-[10rem]">

    <div id="default-carousel" class="relative w-full lg:my-20 md:my-20 h-full max-sm:mt-20 p-10" data-carousel="slide">
      <!-- Carousel wrapper -->
      <div class="relative h-56 overflow-hidden rounded-lg md:h-[33rem]">
        <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="./carousel_images/1_carousel_home.png"
            class="absolute block w-full h-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="./carousel_images/3_carousel_supreme.jpg"
            class="absolute block w-full h-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="...">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="./carousel_images/2_carousel_high.jpg"
            class="absolute block w-full h-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="...">
        </div>
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="./carousel_images/4_carousel_statue.jpeg"
            class="absolute block w-full h-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="...">
        </div>
        <!-- Item 5 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="./carousel_images/5_carousel_book.jpeg"
            class="absolute block w-full h-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="...">
        </div>
      </div>
  ...
  <div class="pt-10">
    <div class="container px-3 mx-auto flex flex-col items-center">
      ...
      <div class="w-full text-center">
        <p class="uppercase tracking-loose w-full animate-fadeInDown lg:text-xl md:text-xl font-bold">LawBridge -
          Bridging
          the Gap to Justice</p>
        <!-- <h1 class="my-4 text-5xl font-bold leading-tight animate-[pulse_2s_ease-in-out_infinite] max-sm:text-2xl">
          Your Trusted Legal Partner for a Secure Future
        </h1> -->
        <h1 class="my-4 text-5xl font-bold leading-tight animate-[pulse_2s_ease-in-out_infinite] max-sm:text-2xl">

          <a href="" class="typewrite" data-period="2000"
            data-type='["Your Trusted Legal Partner.", "We Love to Serve.", "We Got You." ]'>
            <span class="wrap"></span>
          </a>
        </h1>
        <button
          class="hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out max-sm:py-2 max-sm:px-4 max-sm:mb-10 max-sm:mt-0">
          <a href="">
            Contact Us &nbsp;
            <!-- <box-icon type="solid" name="rocket" class="animate-[bounce_3s_ease-in-out_infinite]"></box-icon> -->
            <i class='bx bxs-rocket bx-xs md:bx-md bx-fade-right'></i>
          </a>
        </button>
      </div>
  ...
  <section class="bg-white border-b py-8">
    <div class="container max-w-7xl mx-auto m-3 rounded-3xl py-4 gradient-practice max-sm:p-1">
      <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-100 max-sm:text-2xl">
        Our Practice <span class="text-gray-300">Areas</span>
      </h1>
      <div class="w-full mb-4">
        <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
      </div>
      <div class="p-2 max-sm:p-1 flex flex-wrap items-center justify-center max-sm:pt-0 ">

        <div class="p-2 flex flex-wrap items-center justify-center max-sm:pt-0 ">

          <!-- starting of small cards -->
          <div
            class="flex-shrink-0 border border-xl border-white gradient m-6 relative overflow-hidden bg-slate-600 rounded-lg max-w-xs shadow-lg drop-shadow-xl max-sm:m-1 max-sm:max-w-[16rem]">
            ...
            <div class="relative text-white px-6 pb-6 mt-6 max-sm:mt-3 max-sm:pb-3 max-sm:px-3">
              <!-- <span class="block opacity-80 -mb-1 text-black">Indoor</span> -->
              <div class="flex justify-between">
                <span class="block font-semibold text-xl text-white px-3 uppercase max-sm:text-sm">CIVIL MATTERS</span>

                <!-- what we offer button -->
                <a href="" class="lg:hover:hover:scale-[1.1] md:hover:scale-[1.1] duration-300">
                  <span
                    class="block bg-white rounded-full text-orange-500 text-xs font-bold px-3 py-2 leading-none flex items-center text-slate-800 max-sm:text-[9px] max-sm:px-1 max-sm:py-1">READ</span>
                </a>
              </div>
            </div>
          </div>
  ...
  <section class="bg-white border-b py-8">
    <div class="container mx-auto flex flex-wrap pt-4 pb-12 md:mx-auto bg-gray-700">
      <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white max-sm:text-2xl">
        OUR TEAMS
      </h1>
      <div class="w-full mb-4">
      ...
      <div class="container mx-auto px-6 md:px-12 xl:px-32">
        <div class="mb-16 max-sm:mb-6 text-center">
          <h2 class="mb-4 text-center text-2xl text-gray-400 font-bold md:text-4xl max-sm:text-sm">LAW BRIDGE</h2>
          <p class="text-white italic lg:w-8/12 lg:mx-auto text-xl max-sm:text-sm"><span
              class="text-green-500 text-2xl font-bold max-sm:text-sm ">
              LawBridge </span> connects you to top-tier legal expertise, offering a seamless pathway to navigate
            complex legal challenges with clarity and confidence.</p>
        </div>
        <div class="grid gap-12 items-center md:grid-cols-3">
          <div class="space-y-4 text-center">
            <img class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
              src="WhatsApp Image 2024-08-12 at 10.02.43 AM.jpeg" alt="woman" loading="lazy" width="640" height="805">
            <div class="font-bold text-white">
              <h4 class="text-2xl">Mudasir Malik</h4>
              <span class="block text-sm text-gray-400">B.A/L.L.B</span>
              <p class="block text-sm text-gray-400">2 Years Experience</p>
            </div>
          </div>
          <div class="space-y-4 text-center">
            ...
            <div>
              <h4 class="text-2xl text-black">Jonathan Doe</h4>
              <span class="block text-sm text-gray-500">Chief Technical Officer</span>
            </div>
          </div>
          <div class="space-y-4 text-center">
            <img class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
              src="https://tailus.io/sources/blocks/classic/preview/images/woman.jpg" alt="woman" loading="lazy"
              width="1000" height="667">
            <div>
              <h4 class="text-2xl text-black">Anabelle Doe</h4>
  ...
  <!-- why choose law bridge section start -->
  <section class="bg-white border-b py-8">
    <div class="container overflow-hidden max-w-7xl mx-auto m-3 rounded-3xl py-4 gradient-practice max-sm:p-1">
      <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-100 max-sm:text-2xl">
        WHY CHOOSE<span class="text-gray-300">LAW BRIDGE</span>
      </h1>
      <div class="w-full mb-4">
        <div class="h-1 mx-auto bg-gray-100 w-64 opacity-25 my-0 py-0 rounded-t"></div>
      </div>
      <div class="p-2 max-sm:ps-10 flex flex-wrap items-center justify-center max-sm:pt-0 ">

        <div class="p-2 flex flex-wrap items-center justify-center min-[200px]:ps-20">

          <!-- starting of small cards -->

          <div class="flex m-3 mr-0 ">
            <div class="mx-md:w-[50%] float-left ps-10 max-[910px]:ps-0">
              <img src="./why_choose_imgaes/why_1.jpeg" alt="Description"
                class="object-cover w-[20rem] h-full border-l-4 border-l-amber-300 rounded-lg float-left">
            </div>
            <div class="w-full ps-4 text-justify pt-4 pe-[10rem] min-[650px]:pe-5 ">
              <h1 class="text-xl font-bold">Expert Legal Team</h1>
              <p class="sm:text-base max-sm:truncate max-sm:max-w-xs"> At LawBridge, we pride ourselves on having a team
                of highly skilled attorneys who bring years of experience across a wide array of legal fields. Whether
                you're navigating the complexities of corporate law, resolving family matters, or facing civil
                litigation <span class="max-[910px]:hidden"> our team is equipped to offer you top-notch legal advice
                  and representation. We understand that every client's situation is unique, which is why we take the
                  time to tailor our services to meet your specific needs, ensuring that you receive the best possible
                  outcome</span>.</p>
            </div>
          </div>
          ...
          <div class="flex m-3 mr-0 ">
            <div class="mx-md:w-[50%] float-left ps-10 max-[910px]:ps-0">
              <img src="./why_choose_imgaes/why_3.jpeg" alt="Description"
                class="object-cover w-[20rem] h-full border-l-4 border-l-amber-300 rounded-lg float-left">
            </div>
            <div class="w-full ps-4 text-justify pt-4 pe-[10rem] min-[650px]:pe-5 ">
              <h1 class="text-xl font-bold">Comprehensive Services</h1>
              <p class="sm:text-base max-sm:truncate max-sm:max-w-xs"> LawBridge is more than just a law firm; we are a
                full-service legal partner committed to addressing all your legal needs. From corporate law to family
                disputes and civil litigation, we cover a broad spectrum of legal challenges<span
                  class="max-[910px]:hidden"> Our comprehensive services are designed to provide you with the support
                  and expertise required to navigate even the most complex legal matters. No matter the nature of your
                  case, our team is prepared to offer you the guidance and representation necessary to achieve a
                  favorable resolution</span>.</p>
            </div>
          </div>
          <div class="flex m-3 mr-0 ">
            <div class="mx-md:w-[50%] float-left ps-10 max-[910px]:ps-0">
              <img src="./why_choose_imgaes/why_2.jpeg" alt="Description"
                class="object-cover w-[20rem] h-full border-l-4 border-l-amber-300 rounded-lg float-left">
            </div>
            <div class="w-full ps-4 text-justify pt-4 pe-[10rem] min-[650px]:pe-5 ">
              <h1 class="text-xl font-bold">Expert Legal Team</h1>
              <p class="sm:text-base max-sm:truncate max-sm:max-w-xs"> At LawBridge, we believe that everyone deserves
                access to justice, regardless of their background or circumstances. Our commitment is to provide fair,
                compassionate, and effective legal representation to all our clients<span class="max-[910px]:hidden"> We
                  work tirelessly to ensure that your rights are protected and that you receive the justice you deserve.
                  Whether you’re facing a personal legal challenge or require support in a complex corporate matter, our
                  dedicated team is here to stand by your side every step of the way. At LawBridge, justice isn’t just a
                  word; it’s our mission</span>.</p>
            </div>
          </div>
          <div class="flex m-3 mr-0 ">
            <div class="mx-md:w-[50%] float-left ps-10 max-[910px]:ps-0">
              <img src="./why_choose_imgaes/why_4.jpeg" alt="Description"
                class="object-cover w-[20rem] h-full border-l-4 border-l-amber-300 rounded-lg float-left">
            </div>
            <div class="w-full ps-4 text-justify pt-4 pe-[10rem] min-[650px]:pe-5 ">
              <h1 class="text-xl font-bold">Expert Legal Team</h1>
              <p class="sm:text-base max-sm:truncate max-sm:max-w-xs"> Over the years, LawBridge has built a reputation
                for achieving successful outcomes for our clients. <span class="max-[910px]:hidden"> Our track record
                  speaks for itself, with countless clients having benefited from our diligent work, strategic planning,
                  and unwavering commitment to their cases. We take pride in our history of delivering positive results,
                  whether it's securing a favorable verdict, negotiating a beneficial settlement, or providing sound
                  legal advice. When you choose LawBridge, you're choosing a firm with a proven history of
                  success.</span>.</p>
            </div>
          </div>
  ...
  <!-- why choose law bridge section  end-->

  <!-- FAQ section start -->
  <section class="bg-white py-8 px-8" id="homeLocation">
    <div class="container max-w-7xl mx-auto m-3 rounded-3xl py-4 py-2 ">
      <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-black uppercase max-sm:text-2xl">
        LOCATION
      </h1>
      <div class="w-full mb-4">
        <div class="h-1 mx-auto gradient-practice w-64 opacity-75 my-0 py-0 rounded-t"></div>
      </div>

      <div class="container w-full mx-auto m-3 rounded-3xl gradient-faq">
        <div class="relative w-full h-96 ">
          <iframe class="absolute top-0 left-0 w-full h-full rounded-2xl"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d226.33814596106228!2d67.10319353128897!3d24.81565516749244!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33bba2f9bc2bb%3A0xc0edebe2a55a2e68!2sMalik%20M.%20Yaseen%20Law%20Associates%20%26%20Advisor!5e0!3m2!1sen!2s!4v1725191770610!5m2!1sen!2s"
            frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0">
          </iframe>
        </div>

        <!-- <div id="accordion-color" data-accordion="collapse" class="px-4" -->
        <!-- data-active-classes="bg-transparent dark:bg-gray-800 text-blue-600 dark:text-white"> -->
        <!-- <h2 id="accordion-color-heading-1">
          <button type="button"
            class="flex items-center justify-between w-full p-5  rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-400 dark:hover:bg-gray-800 gap-3 font-bold"
            data-accordion-target="#accordion-color-body-1" aria-expanded="true" aria-controls="accordion-color-body-1">

     
            <box-icon type='solid' name='badge-check' size="sm" color="green" animation="tada"></box-icon>
        ...
        <!-- <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
          <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
            <p class="mb-2 text-black dark:text-white">Flowbite is an open-source library of interactive
              components built on top of Tailwind CSS including buttons, dropdowns, modals, navbars, and more.</p>
            <p class="text-black dark:text-white">Check out this guide to learn how to <a
        ...
        <!-- <h2 id="accordion-color-heading-2">
          <button type="button"
            class="flex items-center justify-between w-full p-5 font-bold rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-400 dark:hover:bg-gray-800 gap-3"
        ...
        <!-- <div id="accordion-color-body-2" class="hidden" aria-labelledby="accordion-color-heading-2">
          <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
            <p class="mb-2 text-black dark:text-white">Flowbite is first conceptualized and designed using the
              Figma software so everything you see in the library has a design equivalent in our Figma file.</p>
            <p class="text-black dark:text-white">Check out the <a href="https://flowbite.com/figma/"
        ...
        <div id="accordion-color-body-3" class="hidden" aria-labelledby="accordion-color-heading-3">
          <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
            <p class="mb-2 text-black dark:text-white">The main difference is that the core components from
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              ...
              <div class=" w-full lg:w-48 h-64">
                <img src="aboutus_images/adv_yaseen.jpeg" alt="image"
              ...
              <div class="text-center lg:text-left lg:max-w-xs flex-1">
                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                  ...
                  <span class="text-sm advocateSubName group-hover:text-indigo-600">Advocate High Court
                  </span>
                </div>
          ...
          <div class="swiper-slide">
            <div
              ...
              <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                <img src="aboutus_images/adv_usama.jpeg" alt="image"
                  class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
              </div>
          ...
          <div class="swiper-slide">
            <div
              class="group w-full flex-wrap flex items-center gap-8  transition-all duration-500 p-8  lg:flex-nowrap">
              <div class=" w-full lg:w-48 h-64">
                <img src="aboutus_images/adv_hamza.jpeg" alt="image"
                  class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
              </div>
              <div class="text-center lg:text-left lg:max-w-xs flex-1">
                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
  ...
  <section class="container mx-auto text-center py-1 mb-5 px-10">
  ...
  <footer class="w-full">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <h3 class="text-center font-bold">LAW BRIDGE ASSOCIATES</h3>
      <!--Grid-->
      <div class="py-7 border-t border-gray-200">
        <div class="h-auto pb-8 flex items-center justify-center gap-4 flex-wrap">
          ...
          <!-- whatsapp link -->
          <a href="https://wa.me/923102654491/?text=Welcome%20To%20Bridge%20Law%20Associate%20How%20we%20can%20help%20you%20today!"
            target="_blank"
            class="w-10 h-10 flex items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 group transition-all duration-300">
            <svg class="transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="28"
              height="28" viewBox="0 0 71 72" fill="none">
              <path
          ...
          <!-- <a href="#"
                 ...
                 <svg class="transition-all duration-300 group-hover:scale-110"
                     xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 71 72" fill="none">
                     <path
          ...
          <!-- <a href="#"
                 class="w-10 h-10 flex items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                 <svg class="rounded-md transition-all duration-300 group-hover:scale-110" width="28" height="28"
                     viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
          ...
          <a href="#"
            ...
            <svg class="rounded-md transition-all duration-300 group-hover:scale-110" width="28" height="28"
              ...
              <path
                ...
                fill="#4285F4" />
              <path d="M50.5732 56.1236H59.056C61.0676 56.1236 62.6914 54.4937 62.6914 52.4881V26.4341L50.5732 35.5227"
                fill="#34A853" />
              <path d="M50.5732 19.7693V35.5229L62.6914 26.4343V21.587C62.6914 17.0912 57.5594 14.5282 53.9663 17.2245"
                fill="#FBBC04" />
